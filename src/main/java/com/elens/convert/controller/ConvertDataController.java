...
public class ConvertDataController {
    ...
    public void exportWord(MultipartFile uploadFile, HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            String content = getString(saveFile);
            saveFile.delete();
            ...
            if (!content.equals("")) {
                ...
                String downloadPath = request.getSession().getServletContext().getRealPath("/") + System.currentTimeMillis() + "/";
...
//    从文件获取字符串
    private String getString(File saveFile) throws IOException {
